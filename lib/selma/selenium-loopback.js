define([], function() {
	...
	var Selenium = {
		...
		canvas: function() { return Selenium.screenshot().then(get2dContext);},
		...
		buttonDown: function(btn) { return post('buttondown', { button: btn || Selenium.LEFT }); },
		buttonUp: function(btn) { return post('buttonup', { button: btn || Selenium.LEFT }); },
		...
		wait: function(millis) { return function() { return new Promise(function(resolve, reject) { setTimeout(resolve, millis); }); }}
	};
